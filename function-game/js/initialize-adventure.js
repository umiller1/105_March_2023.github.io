...
function updatePlayer() {
  ...
  if (isPlayerAttacking()) {
    player.src = 'images/crunchwrap-side-attk.png';
  } else {
    switch(playerDirection) {
      case UP:
        player.src = 'images/crunchwrap-back.png';
        break;
      case DOWN:
        player.src = 'images/crunchwrap-front.png';
        player.classList.remove('face-left');
        break;
      case RIGHT:
        player.src = 'images/crunchwrap-side.png';
        player.classList.remove('face-left');
        break;
      case LEFT:
        player.src = 'images/crunchwrap-side.png';
